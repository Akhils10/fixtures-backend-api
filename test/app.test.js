...
describe('Teams Api', () => {
    ...
    it('POST api/v1/signup should return json', (done) => { 
        request(app)
            .post('/api/v1/signup')
            .send({email: 'test2@test.com', password: 'testuser1', name: 'tester', role: 'adminUser'})
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(function(res){
                res.body.password >= 8
    ...
    it('POST api/v1/login should return j token', (done) => { 
        request(app)
            .post('/api/v1/login')
            .send({email: 'test1@test.com', password: 'testuser1'})
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(function(res){
    ...
    it('List all teams requires token, should return 403', (done) => { 
        request(app)
            .get('/api/v1/teams')
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
